...
function JaeSoLanding() {
  ...
  return (
   <div className={'min-h-dvh flex flex-col pt-8'}>
     <div className={'flex flex-col w-full items-center space-y-8 p-4 relative'}>
     ...
     <a href={"/"} className={'mt-auto ml-auto mb-16'}>
          <span className={'border border-black px-2 py-1 text-xl bg-[#242424] text-[#FEFDF6]'}>
            EXPERIENCE &#8594;
          </span>
     </a>
   </div>
